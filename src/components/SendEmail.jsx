    ...
    return (
        <div className={`${open ? 'block' : 'hidden'} bg-white max-w-6xl shadow-xl shadow-slate-600 rounded-t-md`}>
            ...
            <form onSubmit={submitHandler} className='flex flex-col p-3 gap-2'>
                ...
                <textarea onChange={changeEventHandler} name="message" value={formData.message} placeholder='Type Message' id="" cols="30" rows="10" className='outline-none py-1'></textarea>
